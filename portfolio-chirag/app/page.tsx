    ...
    <div className="relative min-h-screen bg-gradient-to-br from-white to-slate-100 dark:from-neutral-950 dark:to-neutral-900 text-neutral-900 dark:text-neutral-100 font-sans overflow-x-hidden">
            ...
            if (project.type === "card") {
              return (
                <div key={idx} className="bg-white dark:bg-neutral-800 rounded-xl shadow-lg p-6 hover:scale-[1.03] transition-transform group">
                  ...
                  <a href={project.link} className="text-blue-600 dark:text-blue-400 font-medium group-hover:underline">View Project →</a>
                </div>
              );
      ...
      <section id="contact" className="max-w-xl mx-auto py-12 px-4 animate-slide-up">
        ...
        <form className="flex flex-col gap-4">
          {contact.fields.map((field, idx) =>
            field.type === "textarea" ? (
              <textarea
                ...
                rows={field.rows}
                name={field.name}
                className="rounded-lg border px-4 py-2 bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            ) : (
              <input
                key={idx}
          ...
          <button type="submit" className="mt-2 px-6 py-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-colors">{contact.button}</button>
        </form>
      </section>
